...
CREATE TABLE THREE_LINKROAD ( ID INT,CODE VARCHAR,ONECLASSID INT,ONECLASSNAME VARCHAR,ONEMETHODNAME VARCHAR,TWOONECLASSID INT,TWOCLASSNAME VARCHAR,TWOMETHODNAME VARCHAR,TRREECLASSID INT,TRREECLASSNAME VARCHAR,TRREEMETHODNAME VARCHAR);
-- type views
